...
export function generateKey(name: string): Ed25519KeyIdentity {
  ...
  console.warn(`There is already a key with the name ${name} in keys.json...`);
  return keys[name];
}
